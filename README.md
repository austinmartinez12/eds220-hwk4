...
- Landsat 8 Raster: The data was retrieved from the Microsof Planetary Computer data catalogue and clipped to an area surrounding the fire perimeters. It can be found on this link: https://planetarycomputer.microsoft.com/dataset/landsat-c2-l2 
...
- 3. EDS 220. (2025). Assignment 4: Visualizing fire scars through false color. California State University, Dominguez Hills. Retrieved November 22, 2025, from https://meds-eds-220.github.io/MEDS-eds-220-course/assignments/assignment4-palisades.html. [Accessed Nov. 20, 2025]
